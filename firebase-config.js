...
export { app, db, auth, provider, collection, addDoc, serverTimestamp, getDocs, doc, setDoc, getDoc, updateDoc, createUserWithEmailAndPassword, signInWithPopup, onAuthStateChanged, signOut };
